...
var esm_exports = /* @__PURE__ */ __exportAll({ Geolocation: () => Geolocation$1 });
var Geolocation$1 = registerPlugin("Geolocation", { web: () => Promise.resolve().then(() => web_exports).then((m) => new m.GeolocationWeb()) });
f();
//#endregion
//#region node_modules/@capacitor/geolocation/dist/esm/web.js
var web_exports = /* @__PURE__ */ __exportAll({ GeolocationWeb: () => GeolocationWeb });
