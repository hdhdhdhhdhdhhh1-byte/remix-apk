...
var LocalNotifications = registerPlugin("LocalNotifications", { web: () => Promise.resolve().then(() => web_exports).then((m) => new m.LocalNotificationsWeb()) });
//#endregion
//#region node_modules/@capacitor/local-notifications/dist/esm/web.js
var web_exports = /* @__PURE__ */ __exportAll({ LocalNotificationsWeb: () => LocalNotificationsWeb });
